...
NOTE: The creation of the *DevWorkspace* instance can take a few minutes.
...
After the Dev Workspace is created, you are redirected to the VS Code development environment.
