...
Before you continue, close one of the terminal windows.

IMPORTANT: Click the *Trash can* icon on the lower right of the window to close one of the terminals.

image::app/19-cleanup.png[]

Clear all output in the remaining terminal window. Click in the terminal window and type the following command, then press `Enter`.
...
You should see a clean terminal window:

image::app/20-clean.png[]
